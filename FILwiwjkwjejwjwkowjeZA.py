...
def tellm(update,context):
    global user ,msgSN,msdisqus,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour,msflickr,msycomb,msslack,msbitb,mspinter
    query = update.callback_query
...
def pinter(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour,msflickr,msycomb,msslack,msbitb,mspinter
    query = update.callback_query
    time.sleep(0.4)
...
def bitb(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour,msflickr,msycomb,msslack,msbitb
    query = update.callback_query
    time.sleep(0.4)
...
def slack(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour,msflickr,msycomb,msslack
    query = update.callback_query
    time.sleep(0.4)
...
def ycomb(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour,msflickr,msycomb
    query = update.callback_query
    time.sleep(0.4)
...
def flickr(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour,msflickr
    query = update.callback_query
    time.sleep(0.4)
...
def four(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab,msfour
    query = update.callback_query
    time.sleep(0.4)
...
def gitlab(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast,msgitlab
    query = update.callback_query
    time.sleep(0.4)
...
def past(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp,mspast
    query = update.callback_query
    time.sleep(0.4)
...
def wordp(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify,mswordp
    query = update.callback_query
    time.sleep(0.4)
...
def spotify(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr,msspotify
    query = update.callback_query
    time.sleep(0.4)
...
def goodr(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime,msgoodr
    query = update.callback_query
    time.sleep(0.4)
...
def vimeo(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND,msvime
    query = update.callback_query
    time.sleep(0.4)
...
def sond(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT,msSND
    query = update.callback_query
    time.sleep(0.4)
...
def yout(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms,msYUT
    query = update.callback_query
    time.sleep(0.4)
...
def face(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth,ms
    query = update.callback_query
    time.sleep(0.4)
...
def gitHB(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh,megth
    query = update.callback_query
...
def TWSH(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK,msTh
    time.sleep(0.4)
    query = update.callback_query
...
def tiktok(update,context):
    global user ,msgSN,msgt,msgTW,msgTIK
    time.sleep(0.4)
    query = update.callback_query
